        ...
        <form className="flex basis-full" autoComplete="off">
            <div className="flex w-full flex-col items-center gap-6 my-10">
                <div className="relative flex w-full items-center">
                    ...
                    name="search"
                    type="text"
                    className="w-full rounded-xl px-16 py-4 text-white bg-zinc-900 hover:bg-zinc-800 caret-white transition-all duration-300"
                    placeholder="Do que seu pet precisa hoje?"
                    />
